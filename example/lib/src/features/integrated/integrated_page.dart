...
class IntegratedPage extends MVVM<IntegratedModel, IntegratedPageView, IntegratedVM> {
...
class _IntegratedRestaurantsPage extends ViewWidget<IntegratedVM> {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: 600,
      child: MockWidget(
        child: RestaurantsPage(model: RestaurantsModel(isUserLocationPaused: isPaused)),
      ),
    );
  }
}
