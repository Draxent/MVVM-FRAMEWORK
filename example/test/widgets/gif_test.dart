...
void main() {
  group('Gif', () {
    ...
    testWidgets('should handle state changes between paused and playing', (tester) async {
...
Widget _buildGif({bool isPaused = false, bool isFlippedHorizontally = false}) => AppWrapper(
  child: Gif(
    path: _gifPath,
    size: _gifSize,
    isPaused: isPaused,
