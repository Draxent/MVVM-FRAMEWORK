...
void main() {
  ...
  testWidgets(
    ...
    (tester) => _testButtonNavigation(tester, uut, router, 'Basic Feature', BasicPage.name),
  );

  testWidgets(
    'should have a button that navigates to CounterPage',
    (tester) => _testButtonNavigation(tester, uut, router, 'Counter Feature', CounterPage.name),
  );

  testWidgets(
    'should have a button that navigates to RestaurantsPage',
    (tester) =>
        _testButtonNavigation(tester, uut, router, 'Restaurants Feature', RestaurantsPage.name),
  );

  testWidgets(
    'should have a button that navigates to IntegratedPage',
    (tester) =>
        _testButtonNavigation(tester, uut, router, 'Integrated Feature', IntegratedPage.name),
  );
}
