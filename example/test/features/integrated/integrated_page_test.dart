...
class MockIntegratedMVVM extends MVVM<IntegratedModel, IntegratedPageView, IntegratedVM> {
...
void main() {
  group('IntegratedPage', () {
    ...
    testWidgets('should render the page and display the initial state', (tester) async {
    ...
    testWidgets('should change counter submitted value when button is pressed', (tester) async {
      await tester.pumpWidget(uut);
    ...
    testWidgets('should toggle user location state when pause button is pressed', (tester) async {
      await tester.pumpWidget(uut);
    ...
    testWidgets('should toggle user location state when resume button is pressed', (tester) async {
