...
class MockTestMVVM extends MVVM<TestModel, TestView, TestVM> {
  MockTestMVVM({
    TestVM? vm,
    super.isLoadingManagedAutomatically,
    super.key,
...
void main() {
  group('MVVM', () {
    ...
    testWidgets('should show loading indicator whe view state is loading', (tester) async {
    ...
    testWidgets('should return correct widget when building', (tester) async {
      ...
      await tester.pumpWidget(
          AppWrapper(child: MockTestMVVM(vm: vm, isLoadingManagedAutomatically: false)));
